...
export default function ReturnsPage() {
  ...
  const handleViewInvestment = (poolId: string) => {
        ...
        <div className="flex-1 flex items-center justify-center p-4">
          <div className="bg-white rounded-xl shadow-lg p-8 max-w-md w-full text-center">
            ...
            <p className="text-gray-600 mb-6">
              Please connect your wallet to view your investment returns.
            </p>
            {pannaConfigured && (
              <button
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex justify-between items-center">
            ...
            <nav className="hidden md:flex items-center gap-8">
              ...
              <Link href="/returns" className="text-cyan-400 hover:text-cyan-300 hover-color relative after:absolute after:bottom-0 after:left-0 after:w-full after:h-0.5 after:bg-cyan-400">Returns</Link>
            </nav>
      ...
      {/* Returns Content */}
      <InvestorPaymentTracking onViewInvestment={handleViewInvestment} />
