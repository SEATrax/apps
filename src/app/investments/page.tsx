...
export default function InvestmentsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex justify-between items-center">
            ...
            <nav className="hidden md:flex items-center gap-8">
              ...
              <Link href="/investments" className="text-cyan-400 hover:text-cyan-300 hover-color relative after:absolute after:bottom-0 after:left-0 after:w-full after:h-0.5 after:bg-cyan-400">Investments</Link>
      ...
      {/* Investments Content */}
      <InvestmentFlow onPoolSelect={handlePoolSelect} onViewPayments={handleViewPayments} />
